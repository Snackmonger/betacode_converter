# coding: utf-8
# Originally from https://github.com/perseids-tools/beta-code-py/blob/master/beta_code/beta_code.py. Used here for educational purposes.
# The files json_to_beta_code.json and beta_code_to_json.json also belong to that repository.
import json
import os
import re
import unicodedata
